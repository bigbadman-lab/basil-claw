...
- **Knowledge store:** Postgres holds sources, chunks, and embeddings (pgvector). Optional tables x_mentions, x_replies, x_cursor support a future X automation loop.
...
- **x_mentions** / **x_replies** / **x_cursor** — for planned X mention loop and audit
...
- **Architected for automated operation** — Schema and flow support an X mention loop (not yet implemented)
